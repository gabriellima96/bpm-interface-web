...
/**
 * @description variável global do arquivo workflow-cockpit.js
 */
declare var workflowCockpit: any;

/**
 * @description classe que manipula funções do workflow G7.
 */
@Injectable({
  providedIn: 'root',
})
